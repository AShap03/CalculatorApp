...
//  Calculator
//
//  Created by Pavel Ushakov on 7.03.22.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        VStack {
            HStack {    // Stack with entered parameters
                Spacer()
            ...
            HStack {    // Stack with results of calculation
                Spacer()
                Text(visibleResults)
                    .padding()
                    .foregroundColor(Color.white)
    ...
    func buttonPressed(cell: String) {
        ...
        case "AC":
            ...
            visibleWorkings = ""
        case "⌦":
            visibleResults = String(visibleWorkings.dropLast())
        case "=":
